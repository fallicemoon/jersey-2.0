...
public class SellCaseService {
	...
	public SellCaseVO getOne(String id) {
	...
	public Set<PurchaseCaseVO> getPurchaseCasesBySellCaseId(String id) {
	...
	public void addSellCaseIdToPurchaseCases(String sellCaseId, Integer[] purchaseCaseIds) {
	...
	public SellCaseWithBenefitVO getSellCaseWithBenefitVo(SellCaseVO sellCaseVO) {
		...
		if (sellCaseVO != null) {
			...
			sellCaseWithBenefitVo
					.setBenefit(sellCaseVO.getCollected() - sellCaseVO.getTransportCost() - costs - agentCosts);
			sellCaseWithBenefitVo
					.setEstimateBenefit(sellCaseVO.getIncome() - sellCaseVO.getTransportCost() - costs - agentCosts);
